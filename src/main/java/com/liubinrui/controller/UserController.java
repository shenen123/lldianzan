...
import static com.liubinrui.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Boolean> updateUser(@RequestBody UserUpdateRequest userUpdateRequest,
        ...
        ThrowUtils.throwIf(!userUpdateRequest.getId().equals(loginUser.getId()), ErrorCode.NO_AUTH_ERROR);
